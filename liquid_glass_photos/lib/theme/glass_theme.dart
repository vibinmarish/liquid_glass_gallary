...
class GlassColors {
  ...
  static final glassElevatedDark = const Color(
    0xFF2C2C2E,
    ...
    return ThemeData(
      ...
      textTheme: TextTheme(
        ...
        bodyLarge: TextStyle(
          color:
              isDark
                  ? GlassColors.textPrimaryDark
                  : GlassColors.textPrimaryLight,
          fontSize: 16,
        ),
        bodyMedium: TextStyle(
          color:
              isDark
                  ? GlassColors.textSecondaryDark
                  : GlassColors.textSecondaryLight,
          fontSize: 14,
        ),
      ),
    );
