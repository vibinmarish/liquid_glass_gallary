...
class AlbumProvider extends ChangeNotifier {
  ...
  Future<void> loadAlbums() async {
    ...
    try {
      ...
      for (final path in paths) {
        ...
        final List<AssetEntity> covers = await path.getAssetListRange(start: 0, end: 1);
      ...
      if (!_systemAlbums.any((a) => a.id == 'favorites' || a.name.toLowerCase() == 'favorites')) {
        ...
        final favIndex = _systemAlbums.indexWhere((a) => a.id == 'favorites' || a.name.toLowerCase() == 'favorites');
        if (favIndex > 0) {
  ...
  bool _isSystemAlbum(String name) {
    final systemNames = [
      'All', 'Recent', 'Camera', 'Screenshots', 'Videos', 
      'Download', 'DCIM', 'Pictures', 'Movies',
      'Recents', 'Camera Roll', 'All Photos', 'All Videos',
    ];
    return systemNames.any((s) => 
  ...
  Future<void> _loadWebDemoData() async {
    ...
    _systemAlbums = [
      Album(id: 'all', name: 'All Photos', itemCount: 234, isSystem: true, thumbnailUrl: 'https://picsum.photos/seed/all/200/200'),
      Album(id: 'camera', name: 'Camera', itemCount: 156, isSystem: true, thumbnailUrl: 'https://picsum.photos/seed/camera/200/200'),
      Album(id: 'screenshots', name: 'Screenshots', itemCount: 42, isSystem: true, thumbnailUrl: 'https://picsum.photos/seed/screenshots/200/200'),
      Album(id: 'videos', name: 'Videos', itemCount: 18, isSystem: true, thumbnailUrl: 'https://picsum.photos/seed/videos/200/200'),
    ];
    
    _userAlbums = [
      Album(id: 'vacation', name: 'Vacation 2025', itemCount: 89, thumbnailUrl: 'https://picsum.photos/seed/vacation/200/200'),
      Album(id: 'family', name: 'Family', itemCount: 67, thumbnailUrl: 'https://picsum.photos/seed/family/200/200'),
      Album(id: 'work', name: 'Work', itemCount: 23, thumbnailUrl: 'https://picsum.photos/seed/work/200/200'),
    ];
